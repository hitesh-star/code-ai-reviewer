...
Google Generative AI API key (Get it here)
...
Paste Code: Enter or paste the code you want to review in the code editor

Select Language: Choose the programming language for accurate syntax highlighting

Submit for Review: Click the "Review Code" button

Get AI Feedback: Wait for the AI analysis and view recommendations

Copy or Export: Copy the review feedback as needed
...
Prompt Engineering: Structured system prompts guide the AI to focus on code quality, security, and best practices

Code Analysis: AI analyzes for:
...
Formatted Output: Results are returned as Markdown for easy reading
